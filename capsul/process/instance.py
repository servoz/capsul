...
def get_process_instance(process_or_id, capsul_engine=None, **kwargs):
    ...
    # If the function 'process_or_id' parameter is a Process class.
        ...
        result = process_or_id(capsul_engine=capsul_engine)
        ...
        if result is None and not as_xml:
            ...
            if module_object is not None:
                if (isinstance(module_object, type) and
                    ...
                    result = module_object(capsul_engine=capsul_engine)
